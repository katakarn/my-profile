...
function App() {
  ...
  const footer = [(
    <span>
      <Button label="Info" icon="pi pi-heart-fill" style={{ margin: '-13px' }} onClick={() => window.location.href = 'https://www.facebook.com/pond.bangpain'} />
    </span>
  ), <span>
    <Button label="Info" icon="pi pi-heart-fill" style={{ margin: '-13px' }} onClick={() => window.location.href = 'https://www.facebook.com/profile.php?id=100003090333782'} />
  </span>];
  return (
    <div className="App" style={{ background: "#f5f5f7" }}>
      ...
      <div className="card" style={{
        ...
        <Card title="Advanced Card" subTitle="Subtitle" style={{
          color: "#1d1d1f",
          width: "300px",
          height: "600px",
          borderRadius: "20px",
          ...
          <p className="m-0" style={{ lineHeight: '1.5', margin: '0px' }}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore sed consequuntur error repudiandae numquam deserunt
